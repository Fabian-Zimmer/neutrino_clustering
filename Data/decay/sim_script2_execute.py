...
decayed_neutrinos_theta = jnp.load(
    f'{pars.directory}/decayed_neutrinos_theta_{gamma}.npy')
decayed_neutrinos_phi = jnp.load(
    f'{pars.directory}/decayed_neutrinos_phi_{gamma}.npy')
decayed_neutrinos_z = jnp.load(
    f'decays_gamma/decayed_neutrinos_z_{gamma}.npy')
decayed_neutrinos_index_z = jnp.load(
    f'decays_gamma/decayed_neutrinos_index_z_{gamma}.npy', allow_pickle=True)
z_array = jnp.load(
    f'sim_output/no_gravity/z_int_steps.npy')
neutrino_momenta = jnp.load(
    f'sim_output/no_gravity/neutrino_momenta.npy')
...
def EOMs(s_val, y, args):
    ...
    Nr_index, s_int_steps, z_int_steps, zeds_snaps, snaps_GRID_L, snaps_DM_com, snaps_DM_num, snaps_QJ_abs, dPsi_grid_data, cell_grid_data, cell_gens_data, DM_mass, kpc, s, angle_momentum_decay,decayed_neutrinos_z, z_array, neutrino_momenta,decayed_neutrinos_phi,decayed_neutrinos_theta = args
...
def backtrack_1_neutrino(
    ...
    dPsi_grid_data, cell_grid_data, cell_gens_data, DM_mass, kpc, s,angle_momentum_decay,decayed_neutrinos_z,z_array,neutrino_momenta,decayed_neutrinos_phi,decayed_neutrinos_theta):
    ...
    sol = diffrax.diffeqsolve(
        ...
        args=( 
            Nr.astype(int), s_int_steps, z_int_steps, zeds_snaps, snaps_GRID_L, snaps_DM_com, snaps_DM_num, snaps_QJ_abs, dPsi_grid_data, cell_grid_data, cell_gens_data, DM_mass, kpc, s, angle_momentum_decay,decayed_neutrinos_z, z_array, neutrino_momenta,decayed_neutrinos_phi,decayed_neutrinos_theta)
    )
...
for halo_j, halo_ID in enumerate(halo_batch_IDs):
    ...
    common_args = (
        s_int_steps, z_int_steps, zeds_snaps, snaps_GRID_L, snaps_DM_com, snaps_DM_num, snaps_QJ_abs, dPsi_grids, cell_grids, cell_gens, DM_mass, Params.kpc, Params.s , angle_momentum_decay,decayed_neutrinos_z,z_array,neutrino_momenta,decayed_neutrinos_phi,decayed_neutrinos_theta)
